...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.stack([arr[0],arr[0],arr[0],arr[1],arr[1],arr[1],arr[2],arr[2],arr[2],arr[0],arr[1],arr[2],arr[0],arr[1],arr[2],arr[0],arr[1],arr[2]])
...
def function17():
    ...
    return    ans = np.where((arr%3|arr%5==0), 'YES', 'NO'); ans      # Write Your Code HERE
...
def function18():
    ...
    a = np.intersect1d(piaic, students); x = np.count_nonzero(a!=0) # Write you code Here
    return x
...
def fucntion20():
    ...
    return x = np.arange(1,11)
a = x*2+3-2 #Write your Code here
